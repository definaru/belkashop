...
class __TwigTemplate_ad499aa68b28ffb83ce165001e2c6872ae62eef4fd4d43edd5514d2b6ce1d8ea extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["currency"]) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context["currency"], "symbol_left", [], "any", false, false, false, 18)) {
                    // line 19
                    echo "        <li>
          <button class=\"currency-select btn btn-link btn-block\" name=\"";
                    // line 20
